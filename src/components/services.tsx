...
const Services = () => {
  return (
    <figcaption className="sm:mt-[5rem]">
      <div className="w-[75.875rem] line h-[0.0625rem] bg-[#E3E8EF]  mx-auto my-0"></div>

      <figure className="services  mx-6 sm:flex md:flex-row md:mx-[7.44rem]  sm:gap-[8rem]">
        <section className="mt-[3rem] sm:mt-[0rem] sm:my-[3rem] md:my-[2rem] sm:ml-[40px] ">
          <div>
            ...
            <p className="text-[#697586] md:h-[9.4375rem]  font-DMSans text-base font-normal leading-[1.3125rem] sm:text-[1.25rem] sm:leading-[1.875rem] pt-[1.25rem] sm:pt-[1.5rem] sm:mb-[5rem]  ">
              {" "}
              {designstuff}
            </p>
        ...
        <section className=" max-[640px]:mt-[4rem] md:my-[2rem]">
          ...
          <p className="text-[#697586] md:h-[9.4375rem] font-DMSans text-base font-normal leading-[1.3125rem] md:text-[1.25rem] md:leading-[1.875rem] pt-[1.25rem] sm:pt-[1.5rem] sm:mb-[5rem]  ">
            {writestuff}
          </p>
